...
from .views import ReportCreateView, ReviewCreateView, TutorApplicationRetrieveCreateUpdateView, FeedbackDeleteView,MyTutorApplicationStatusView
...
urlpatterns = [
    ...
    path('feedback/delete/<int:pk>/', FeedbackDeleteView.as_view(), name='feedback-list-create'),
    ...
    path('tutor-application/status/', MyTutorApplicationStatusView.as_view(), name='tutor-application-status'),
]
