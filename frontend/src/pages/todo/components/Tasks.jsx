      ...
      {!completed ? (
        <div className="py-2 px-2 flex gap-5 flex-col bg-productivity-bg w-full rounded-md ">
          <div className="flex justify-between items-center">
            ...
            <div  onMouseOver={() => handleHover("enter")} onMouseLeave={() => handleHover("leave")}>{hover ? <div className="flex gap-1"><button className="bg-green-400 p-1 rounded-md"><Pen size={16}/></button> <button className="bg-red-500 p-1 rounded-md"><Trash size={16}/></button></div> :<input type="date" value={props.dueDate} />}</div>
          </div>
          {
